var gulp      = require('gulp'), // Подключаем Gulp
    ...
    imagemin = require('gulp-imagemin');// Подключаем библиотеку для уменьщения размера фото
...
gulp.task('scripts', function() {
    return gulp.src([ // Берем все необходимые библиотеки
        ...
        'app/libs/slick-1.8.1/slick.min.js',
        'app/libs/jquery-mousewheel/jquery.mousewheel.min.js',
        'app/libs/TouchSwipe-Jquery-Plugin-master/jquery.touchSwipe.min.js',
        'app/libs/lazy-line-painter-master/jquery.lazylinepainter-1.7.0.min.js'
        ])
        .pipe(uglify())
